...
export type TabState = {
  ...
  isFeedOpen: boolean;
  previousView?: 'chat' | 'feed';
  feed: {
    messageIds: string[]; // Filtered message IDs based on active filter
    allMessageIds: string[]; // All loaded messages (unfiltered) for fast client-side filtering
    isLoading: boolean;
    ...
    isClosing?: boolean; // For smooth slide-out animation
  };
