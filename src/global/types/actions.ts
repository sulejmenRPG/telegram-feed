...
export interface ActionPayloads {
  ...
  toggleFeed: WithTabId | undefined;
  setPreviousView: { view: 'chat' | 'feed' } & WithTabId;
  saveFeedScrollPosition: { scrollPosition: number } & WithTabId;
  ...
  // Feed
  loadFeedMessages: WithTabId | undefined;
  loadMoreFeedMessages: WithTabId | undefined;
  ...
  clearFeedFilter: WithTabId | undefined;
  detachFeedFilter: {
    filterId: string;
  } & WithTabId;
  setFeedInitialScroll: WithTabId | undefined;
}
